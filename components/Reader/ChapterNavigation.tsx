              ...
              >
                ...
                {index > 0 && (
                  <div
                    ...
                    style={{
                      background: "linear-gradient(90deg, transparent, rgba(200, 182, 141, 0.5), transparent)",
                    }}
                  />
                )}
                ...
                <button
                  ...
                  style={{
                    background: isSelected
                      ...
                      : "transparent",
                    border: `1px solid ${isSelected ? "rgba(200, 182, 141, 0.3)" : "rgba(200, 182, 141, 0.1)"}`,
                    color: isSelected ? "#C8B68D" : "rgba(200, 182, 141, 0.7)",
                  }}
                  onMouseEnter={(e) => {
                    if (!isSelected) {
                      e.currentTarget.style.background = "rgba(200, 182, 141, 0.05)";
                    }
                  }}
                  onMouseLeave={(e) => {
                    if (!isSelected) {
                ...
                >
                  <div className="font-serif text-sm mb-1">{chapter.title}</div>
